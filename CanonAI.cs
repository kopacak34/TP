...
public class CanonAI : MonoBehaviour
{
    ...
    public static float baseHealth = 200f; 
    public static float healthIncreaseInterval = 30f;
    public static float healthIncreaseAmount = 40f; 
    ...
    void Start()
    {
        ...
        if (agent == null)
        {
            Debug.LogError("Minion potřebuje komponentu NavMeshAgent!");
        }
    ...
    IEnumerator HealthScalingLoop()
    {
        while (true)
        {
            ...
            Debug.Log($" Základní životy minionů zvýšeny na {baseHealth}");
        }
    }
    ...
    void Shoot()
{
    if (bulletPrefab != null && firePoint != null)
    {
        ...
        CanonBullet bulletScript = bullet.GetComponent<CanonBullet>();
    ...
    public void TakeDamage(float damage)
    {
        ...
        Debug.Log($"{gameObject.name} utrpěl {damage} poškození. Zbývající HP: {currentHealth}");
